    ...
    private void saveCroppedImage() {
        if (ActivityCompat.checkSelfPermission(this, Manifest.permission.WRITE_EXTERNAL_STORAGE)
            ...
            if (imageUri != null && imageUri.getScheme().equals("file")) {
                ...
                Toast.makeText(ResultActivity.this, "Unexpected error occured", Toast.LENGTH_SHORT).show();
            }
        }
...
//        TODO open a
    ...
    private void copyFileToDownloads(Uri croppedFileUri) throws Exception {
        ...
        Log.e("filepath",downloadsDirectoryPath+"/"+filename);
        ...
        Log.e("PATH CROP ",croppedFileUri.getPath());
        Intent intent = new Intent(getBaseContext(),Tutorial2Activity.class);
        intent.setData(croppedFileUri);
        intent.putExtra("filepath",downloadsDirectoryPath+"/"+filename);
