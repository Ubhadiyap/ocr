...
//        setActionBar(toolbar);
        ...
        setTitle("  Read Serial Number");

        TextView textView = (TextView) findViewById(R.id.status_message);
        textView.setText("Click the pink button below to read the Meter Serial using the camera");
        ...
        read.setText("Read Meter Serial");
    }
...
//                    TODO handle after detecting text here. Draw a popup to continue if successful to another activity
                    ...
                    final String serial = text;
                    AlertDialog.Builder alert = new AlertDialog.Builder(SerialActivity.this);

                    alert.setTitle("Please confirm. Is this the meter Serial number?");
                    alert.setMessage(serial);
                    ...
                    alert.setPositiveButton("Yes",
                            new DialogInterface.OnClickListener() {
                                public void onClick(DialogInterface dialog,
                                    ...
                                    MyShortcuts.setDefaults("serial", serial, getBaseContext());
