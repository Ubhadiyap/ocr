package com.eneo.ocr.processing;
...
import com.eneo.ocr.TestCrop;
import com.eneo.ocr.processing.util.CameraUtils;
import com.eneo.ocr.processing.util.Notifier;

public class BullseyeCameraManager implements TestCrop.CameraPermissionsListener, CameraUtils.CameraStateListener, CameraUtils.SizeListener, MVRTCameraView.SurfaceReadyListener, CameraUtils.CaptureCallbacks, CameraUtils.CVLoadListener, CVProcessor.ProcessedMatListener {
    ...
    //    TODO this is where i deal with my processed image output
